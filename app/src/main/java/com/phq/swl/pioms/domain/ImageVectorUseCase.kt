...
import com.phq.swl.pioms.domain.embeddings.FaceNet
import com.phq.swl.pioms.domain.face_detection.BaseFaceDetector
import com.phq.swl.pioms.domain.face_detection.FaceSpoofDetector
...
class ImageVectorUseCase(
    ...
    fun hasImages(personID: Long): Boolean {
        return imagesVectorDB.hasImages(personID)
    }
}
