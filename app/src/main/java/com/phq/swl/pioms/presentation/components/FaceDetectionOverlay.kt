package com.phq.swl.pioms.presentation.components
...
class FaceDetectionOverlay(
    ...
    private val onFaceRecognitionResults: ((List<ImageVectorUseCase.FaceRecognitionResult>) -> Unit)? = null,
    private val onManualCapture: ((Bitmap) -> Unit)? = null,
) : FrameLayout(context) {
    ...
    private val analyzer =
        ImageAnalysis.Analyzer { image ->
            ...
            if (pendingManualCapture) {
                ...
                val captureBitmap = frameBitmap.copy(frameBitmap.config ?: Bitmap.Config.ARGB_8888, false)
                CoroutineScope(Dispatchers.Main).launch {
                    onManualCapture?.invoke(captureBitmap)
                }
            }
            ...
            CoroutineScope(Dispatchers.Default).launch {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    onFaceRecognitionResults?.invoke(results)
